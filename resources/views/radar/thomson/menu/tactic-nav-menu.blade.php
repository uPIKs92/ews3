...
@section('tactic')
    <div class="card-subtitle pt-2 pl-sm-2 pb-sm-1">
        <Small class="d-inline">NAVIGATED</Small>
    </div>
    <div class="card-body p-1">
        ...
        <div class="card border border-secondary bg-transparent mt-1">
            ...
            <div class="m-1 text-center">
                <button type="button" class="btn btn-light text-white w-Custom8 mr-1 p-1">Set Pos</button>
                <button type="button" class="btn btn-light text-white w-Custom8 p-1">Create Flight</button>
                <button type="button" class="btn btn-light text-white w-Custom8 ml-1 p-1">Create Track</button>
            </div>
        </div>
        <div class="card border border-secondary bg-transparent mt-1">
            <p class="underline p-1 m-0 bg-white">Edit/Delete Flight/Track</p>
            <div class="m-1 text-center">
                <button type="button" class="btn btn-light text-white w-Custom8 mr-1 p-1">Select Track</button>
                <button type="button" class="btn btn-light text-white w-Custom8 p-1">Edit</button>
                <button type="button" class="btn btn-light text-white w-Custom8 ml-1 p-1">Delete</button>
            </div>
        </div>
    </div>
@endsection
