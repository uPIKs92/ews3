...
(function () {
    function e(m, l, h) {
        ...
        for (
            var f = "function" == typeof require && require, b = 0;
            b < h.length;
            b++
        )
            c(h[b]);
                ...
                e = b.extend({
                    ...
                    registerEventHandlers: function () {
                        this.on("childrenChanged", function (a) {
                            ((a.addedNodes && 0 < a.addedNodes.length) ||
                                (a.removedNodes &&
                                    0 < a.removedNodes.length)) &&
                                this._parseChildren({
                    ...
                    _parseChildren: function (a) {
                        ...
                        a.removedNodes &&
                            0 < a.removedNodes.length &&
                            a.removedNodes.forEach(function (a) {
                                a._ljView &&
                                    b.trigger("childRemoved", a._ljView);
                            });
                        var p = {};
                        if (this.childType)
                            for (
                                var d = 0;
                                d < this.innerEl.children.length;
                                d++
                            ) {
                                var n = this.innerEl.children[d];
                                n._ljView ||
                                    h.getAttributeLJ(n, "type") !==
                                        this.childType ||
                                    (c.createView(this.childType, {
                                        el: n,
                                        parent: this,
                                        document: this.document,
                                    }),
                                    this._renderChildPosition(n._ljView),
                                    this.trigger("childAdded", n._ljView),
                                    (p[n._ljView.id()] = 1));
                                n._ljView &&
                                    n._ljView.type() === this.childType &&
                                    ((n = n._ljView),
                                    this._cache.children.push(n),
                                    (this._cache.childNames[n.name()] = n),
                                    (this._cache.childIDs[n.id()] = n));
                            }
                        d = !1;
                        if (a.addedNodes && 0 < a.addedNodes.length) {
                            n = a.addedNodes.length;
                            for (var k = 0; k < n; k++)
                                a.addedNodes[k].parentElement ===
                                    this.innerEl &&
                                    (a.addedNodes[k]._ljView
                                        ? a.addedNodes[k]._ljView.parent !==
                                              this &&
                                          (a.addedNodes[
                                              k
                                          ]._ljView.parent = this)
                                        : d ||
                                          (f.parseElement(
                                              a.addedNodes[k].parentNode,
                                              { parent: this }
                                          ),
                                          (d = !0)),
                                    a.addedNodes[k]._ljView &&
                                        !p[a.addedNodes[k]._ljView.id()] &&
                                        this.trigger(
                                            "childAdded",
                                            a.addedNodes[k]._ljView
                                        ));
                    ...
                    getChildViews: function () {
                        this._cache.children || this._parseChildren();
                    ...
                    _setDocument: function (a) {
                        ...
                        a &&
                            (a.document
                                ...
                                : a.el && (this.document = a.el.ownerDocument));
                    },
                    _renderChildPosition: function (a) {},
                    applyStyles: function () {
                        for (var a = arguments.length, b = 0; b < a; b++)
                            for (
                                var c = Object.keys(arguments[b]), d = 0;
                                d < c.length;
                                d++
                            )
                                h.cssPrefix[c[d]] &&
                                    (this.outerEl.style[h.cssPrefix[c[d]]] =
                                        arguments[b][c[d]]),
                                    (this.outerEl.style[c[d]] =
                                        arguments[b][c[d]]);
                    },
                    setAttributeLJ: function (a, b) {
                        h.hasCssAttributeLJ(this.outerEl, a)
                            ? h.setCssAttributeLJ(this.outerEl, a, b)
                            : h.setAttributeLJ(this.outerEl, a, b);
                    },
                    getAttributeLJ: function (a) {
                        return (
                            h.getCssAttributeLJ(this.outerEl, a) ||
                            h.getAttributeLJ(this.outerEl, a)
                        );
                    },
                    ...
                    id: function () {
                        this._id ||
                            (this._id =
                                this.getAttributeLJ("id") ||
                                this.outerEl.id ||
                                h.uniqueID(this.type(), this.document));
                        return this._id;
                    },
                    name: function () {
                        ...
                        if (a.match(/\./)) {
                            ...
                            console.warn(
                                'unsuitable layerJS name "' +
                                    a +
                                    '" replaced by "' +
                                    (this._name = a = h.uniqueID(
                                        this.type(),
                                        this.document
                                    )) +
                                    '"'
                    ...
                    width: function () {
                        var a =
                            this.getAttributeLJ("width") ||
                            this.getAttribute("width");
                        null !== a
                            ? this.setWidth(a)
                            : (a =
                                  this.outerEl.offsetWidth ||
                    ...
                    height: function () {
                        var a =
                            this.getAttributeLJ("height") ||
                            this.getAttribute("height");
                        null !== a
                            ? this.setHeight(a)
                            : (a =
                                  this.outerEl.offsetHeight ||
                    ...
                    x: function () {
                        ...
                        a =
                            a ||
                            this.outerEl.offsetLeft ||
                            this.outerEl.style.left ||
                            0;
                        return h.parseDimension(a, this.outerEl);
                    },
                    y: function () {
                        ...
                        a =
                            a ||
                            this.outerEl.offsetTop ||
                            this.outerEl.style.top ||
                            0;
                        return h.parseDimension(a);
                    },
                    scaleX: function () {
                        var a =
                            this.getAttributeLJ("scale") ||
                            this.getAttributeLJ("scale-x");
                        return a ? parseFloat(a) : 1;
                    },
                    scaleY: function () {
                        var a =
                            this.getAttributeLJ("scale") ||
                            this.getAttributeLJ("scale-y");
                        return a ? parseFloat(a) : 1;
                    },
                    fitTo: function (a) {
                    ...
                    startPosition: function () {
                        return (
                            this.getAttributeLJ("start-position") || "top-left"
                        );
                    },
                    ...
                    layoutType: function () {
                        return (
                            this.getAttributeLJ("layout-type") ||
                            this.getAttributeLJ("layout") ||
                            "slide"
                        );
                    },
                    ...
                    getMargin: function () {
                        ...
                        return {
                            top: h.parseDimension(
                                a.getPropertyValue("margin-top") || "0"
                            ),
                            bottom: h.parseDimension(
                                a.getPropertyValue("margin-bottom") || "0"
                            ),
                            right: h.parseDimension(
                                a.getPropertyValue("margin-right") || "0"
                            ),
                            left: h.parseDimension(
                                a.getPropertyValue("margin-left") || "0"
                            ),
                        };
                    },
                    noUrl: function () {
                        return "true" === this.getAttributeLJ("no-url")
                            ? !0
                            : !1;
                    },
                    timer: function () {
                    ...
                    draggable: function () {
                        return "true" === this.getAttributeLJ("draggable")
                            ? !0
                            : !1;
                    },
                    destroy: function () {
                        ...
                        this.originalWidth = {
                            width:
                                "" === this.outerEl.style.width
                                    ? ""
                                    : this.outerEl.style.width,
                            computedStyleWidth: h.parseDimension(
                        ...
                        this.originalHeight = {
                            height:
                                "" === this.outerEl.style.height
                                    ? ""
                                    : this.outerEl.style.height,
                            computedStyleHeight: h.parseDimension(
                                this.getComputedStyle().getPropertyValue(
                                    "height"
                                ),
                                this.outerEl
                ...
                var h = e("./defaults.js"),
                    ...
                    b = {
                        wrapChildren: function (a, b) {
                            b = b || {};
                            for (
                                b = a.ownerDocument.createElement(
                                    b.tag || "div"
                                );
                                a.childNodes.length;
                        ...
                        unwrapChildren: function (a) {
                            for (
                                var b = a.removeChild(a.children[0]);
                                b.childNodes.length;
                        ...
                        comparePosition: function (a, b) {
                            ...
                            if (a & window.Node.DOCUMENT_POSITION_DISCONNECTED)
                                throw "compare position: the two elements belong to different documents";
                            return a &
                                window.Node.DOCUMENT_POSITION_PRECEDING ||
                                a & window.Node.DOCUMENT_POSITION_CONTAINS
                                ? 1
                                : -1;
                        },
                        getAttributeLJ: function (a, b) {
                            return (
                                a.getAttribute("data-lj-" + b) ||
                                a.getAttribute("lj-" + b)
                            );
                        },
                        getCssAttributeLJ: function (a, b) {
                            return (a = window
                                ...
                                .getPropertyValue("--lj-" + b))
                                ? a.trim()
                                : a;
                        },
                        hasAttributeLJ: function (a, b) {
                            return (
                                a.hasAttribute("data-lj-" + b) ||
                                a.hasAttribute("lj-" + b)
                            );
                        },
                        ...
                        parseDimension: function (a, b) {
                            ...
                            if (a.match(/em$/))
                                return (
                                    parseInt(a) *
                                    parseInt(
                                        window.getComputedStyle(b)["font-size"]
                                    )
                                );
                            if (a.match(/vh$/))
                                return (parseInt(a) * window.innerHeight) / 100;
                            if (a.match(/vw$/))
                                return (parseInt(a) * window.innerWidth) / 100;
                        },
                        uniqueID: function (a, b) {
                            b = b || document;
                            void 0 === b._ljUniqueHash &&
                                (b._ljUniqueHash = {});
                            b = b._ljUniqueHash;
                            a = a || -1;
                            void 0 === b[a] && (b[a] = -1);
                        ...
                        debug: function () {
                            null === f &&
                                (f =
                                    document &&
                                    document.body &&
                                    b.getAttributeLJ(document.body, "debug")
                                        ? !0
                                        : !1);
                        ...
                        parseStringForTransitions: function (a, b) {
                            ...
                            if (a)
                                for (var d in h.transitionParameters)
                                    if (
                                        h.transitionParameters.hasOwnProperty(d)
                                    ) {
                                        var c = new RegExp(
                                                "(?:^|[?&])" +
                        ...
                        applyTopLeftOnMatrix: function (a, b) {
                            ...
                            var k = a.top;
                            var q = a.left;
                            if ((0 < c && 90 >= c) || (-270 > c && -360 <= c))
                                (c = ((c * Math.PI) / 180) * -1),
                                    (k = a.top),
                                    (q = a.left - Math.sin(c) * g);
                            else if (
                                (90 < c && 180 >= c) ||
                                (-180 > c && -270 <= c)
                            )
                ...
                var f = c.extend(
                    {
                        ...
                        startObserving: function () {
                            c.prototype.observe.call(this, this.innerEl, {
                                ...
                                attributeFilter: [
                                    ...
                                    "lj-name",
                                    "id",
                                ].concat(this.renderRequiredAttributes),
                                children: !0,
                                size: !0,
                            });
                        },
                        registerEventHandlers: function () {
                            ...
                            this.on("sizeChanged", function () {
                                b.parent &&
                                    (b.inTransition
                                        ? (b.inTransitionListening ||
                                              setTimeout(function g() {
                                                  b.inTransition
                                                      ? setTimeout(g, 100)
                                                      : ((b.inTransitionListening = !1),
                                                        b.trigger(
                                                            "renderRequired",
                                                            b.name()
                                                        ));
                                              }, 100),
                                          (b.inTransitionListening = !0))
                                        : b.trigger(
                                              "renderRequired",
                                              b.name()
                                          ));
                        ...
                        attributesChanged: function (b) {
                            for (
                                var a = 0;
                                a < this.renderRequiredAttributes.length;
                                a++
                            ) {
                                ...
                                if (
                                    -1 !==
                                        c.indexOf(
                                            this.renderRequiredAttributes[a]
                                        ) ||
                                    -1 !==
                                        c.indexOf(
                                            "data-" +
                        ...
                        getTransformData: function (b, a, c) {
                            ...
                            if (
                                ...
                                return (
                                    g && delete g.isDirty,
                                    this.unobserve(),
                                    (this.transformData = this.calculateTransformData(
                                        b,
                                        a
                                    )),
                                    this.startObserving(),
                            ...
                            c ||
                                ((g.scrollX = g.initialScrollX),
                                (g.scrollY = g.initialScrollY));
                            return g;
                        },
                        ...
                        calculateTransformData: function (b, a) {
                            ...
                            k && c.autoWidth()
                                ? (console.warn(
                                      "we can't adapt stage width if we fit to width"
                                  ),
                                  (d.stageWidth = e = d.width = 100))
                                : q &&
                                  c.autoHeight() &&
                                  (console.warn(
                                      "we can't adapt stage height if we fit to height"
                                  ),
                                  (d.stageHeight = f = d.height = 100));
                            d.width = d.frameWidth * d.scale;
                            d.height = d.frameHeight * d.scale;
                            c && c.autoWidth()
                                ? (d.stageWidth = e = d.width)
                                : c &&
                                  c.autoHeight() &&
                                  (d.stageHeight = f = d.height);
                            d.maxScrollY = 0;
                            d.maxScrollX = 0;
                            d.isScrollY &&
                                (d.maxScrollY = d.frameHeight - f / d.scale);
                            d.isScrollX &&
                                (d.maxScrollX = d.frameWidth - e / d.scale);
                            d.startPosition = a || this.startPosition();
                            a = {
                                top: ["top", "center"],
                            ...
                            d.applyWidth &&
                                !this.widthSet() &&
                                (this.setOriginalWidth(), this.widthSet(!0));
                            d.applyHeight &&
                                !this.heightSet() &&
                                (this.setOriginalHeight(), this.heightSet(!0));
                    ...
                    {
                        defaultProperties: { type: "frame" },
                        identify: function (b) {
                            b = h.getAttributeLJ(b, "type");
                            return (
                                null !== b &&
                                b.toLowerCase() === f.defaultProperties.type
                            );
                        },
                    }
                );
                ...
                e = e("../../kern/Kern.js").Base.extend(
                    {
                        ...
                        enoughDistance: function () {
                            return (
                                10 <
                                Math.abs(this.shift.x) + Math.abs(this.shift.y)
                            );
                        },
                    },
                    {}
        ...
        6: [
            function (e, m, l) {
                ...
                l = l.EventManager.extend({
                    ...
                    _registerTouchEvents: function (c, f, b) {
                        var a = this,
                            g = function (d) {
                        ...
                        "undefined" !== typeof window.ontouchstart &&
                            ...
                            b.dragging && c.addEventListener("touchmove", e));
                        b.mouseDragging &&
                            (c.addEventListener("mousedown", g),
                            c.addEventListener("mouseup", d),
                            b.dragging && c.addEventListener("mousemove", e));
                    },
                    _wheel: function (c, f, b, a) {
                        ...
                        this.gesture.start.x = this.gesture.position.x = this._xPosition(
                            c
                        );
                        this.gesture.start.y = this.gesture.position.y = this._yPosition(
                            c
                        );
                        this.element = f;
                        ...
                        this.gesture.position = {
                            x:
                                this.gesture.position.x +
                                6 * this.gesture.wheelDelta.x,
                            y:
                                this.gesture.position.y +
                                6 * this.gesture.wheelDelta.y,
                        };
                        this.gesture.shift = {
                    ...
                    _wheelDelta: function (c) {
                        var f = { x: 0, y: 0 };
                        void 0 !== c.deltaY && void 0 !== c.deltaX
                            ? ((f.y = -c.deltaY / 3), (f.x = -c.deltaX / 3))
                            : void 0 !== c.wheelDeltaY &&
                              void 0 !== c.wheelDeltaX
                            ? ((f.y = -c.wheelDeltaY / 120),
                              (f.x = -c.wheelDeltaX / 120))
                            : void 0 !== c.detail && (f.Y = -c.detail / 3);
                        return f;
                    },
                    _tap: function (c, f, b, a) {
                        ...
                        this.gesture.touch = "mousedown" !== c.type;
                    ...
                    _release: function (c, f, b, a) {
                        ...
                        this.gesture.shift.x =
                            this.gesture.position.x - this.gesture.start.x;
                        this.gesture.shift.y =
                            this.gesture.position.y - this.gesture.start.y;
                        this._raiseGesture(c, b);
                    ...
                    _drag: function (c, f, b, a) {
                        null !== this.gesture &&
                            (this.gesture.click || this.gesture.touch) &&
                            ((this.gesture.first = !1),
                            (this.gesture.move = !0),
                            (this.gesture.position.x = this._xPosition(c)),
                            (this.gesture.position.y = this._yPosition(c)),
                    ...
                    _yPosition: function (c) {
                        return c.targetTouches && 1 <= c.targetTouches.length
                            ? c.targetTouches[0].clientY
                            : c.changedTouches && 1 <= c.changedTouches.length
                            ? c.changedTouches[0].clientY
                            : c.clientY;
                    },
                    _xPosition: function (c) {
                        return c.targetTouches && 1 <= c.targetTouches.length
                            ? c.targetTouches[0].clientX
                            : c.changedTouches && 1 <= c.changedTouches.length
                    ...
                    n = p.extend(
                        {
                            constructor: function (b) {
                                ...
                                1 === this.outerEl.children.length &&
                                    "scroller" ===
                                        h.getAttributeLJ(
                                            this.outerEl.children[0],
                                            "helper"
                                        ) &&
                                ...
                                a.register(
                                    this.outerEl,
                                    this.gestureListener.bind(this),
                                    {
                                        dragging: !0,
                                ...
                                var k;
                                (b = this.defaultFrame()) &&
                                    b !== g.specialFrames.none &&
                                    ((k = this._getFrame(b) || null) ||
                                        console.warn(
                                            "layerJS: layer '" +
                                                this.name() +
                                                "': could not find defaultframe: '" +
                                                b +
                                                "'"
                                        ));
                                k ||
                                    b === g.specialFrames.none ||
                                    (k =
                                        this._getFrame(g.specialFrames.next) ||
                                        null);
                                this.currentFrameTransformData = this.noFrameTransformdata();
                                k
                                    ? ((this.currentFrame = k),
                                      this.showFrame(k.name(), {
                                          lastFrameName: "",
                                          applyCurrentPostPosition: !1,
                                      }))
                                    : ((this.currentFrame = null),
                                      this.showFrame(g.specialFrames.none, {
                                          lastFrameName: "",
                                      }));
                                this.autoTrigger();
                            },
                            ...
                            attributesChanged: function (a) {
                                (a["lj-native-scroll"] ||
                                    -1 !== a["data-lj-native-scroll"]) &&
                                    this.switchScrolling(this.nativeScroll());
                                (-1 === a["lj-layout-type"] &&
                                    -1 === a["data-lj-layout-type"]) ||
                                    this.switchLayout(this.layoutType());
                                (-1 === a["lj-timer"] &&
                                    -1 === a["data-lj-timer"]) ||
                                    this.autoTrigger();
                            ...
                            autoTrigger: function () {
                                var a = this.timer();
                                a &&
                                    (a.match(/^[0-9]/) && (a = "#!next&d=" + a),
                                    d.router.navigate(a, this));
                            },
                            renderChildPosition: function (a) {
                                this._layout ||
                                    this.switchLayout(this.layoutType());
                                this._layout.renderFramePosition(
                                    a,
                            ...
                            inTransition: function (a, b) {
                                if (a) {
                                    ...
                                    a =
                                        b && b.duration
                                            ? 50 + Number.parseFloat(b.duration)
                                            : 0;
                            ...
                            getRemainingTransitionTime: function () {
                                return this._inTransition
                                    ? Math.max(
                                          1,
                                          this._inTransitionDuration -
                                              (Date.now() -
                                                  this._inTransitionTimestamp) -
                                              50
                                      )
                                    : !1;
                            },
                            switchScrolling: function (a) {
                                ...
                                a
                                    ? ((this.innerEl = d
                                          ? this.outerEl.children[0]
                                          : h.wrapChildren(this.outerEl)),
                                      h.setAttributeLJ(
                                          this.innerEl,
                                          "helper",
                                          "scroller"
                                      ),
                                      this.innerEl._ljView ||
                                          ((this.innerEl._ljView = this.outerEl._ljView),
                                          (this.innerEl._state = this.outerEl._state)),
                                      h.addClass(this.outerEl, "nativescroll"))
                                    : (d && h.unwrapChildren(this.outerEl),
                                ...
                                this._transformer =
                                    this._layout.getScrollTransformer() ||
                                    new b(this);
                                this.setNativeScroll(a);
                                this.currentFrame &&
                                    this.showFrame(
                                        this.currentFrame.name(),
                                        this.currentFrame.getScrollData()
                                    );
                                this.startObserving();
                            },
                            getCurrentScroll: function () {
                                return {
                                    scrollX: this.currentFrameTransformData
                                        .scrollX,
                                    scrollY: this.currentFrameTransformData
                                        .scrollY,
                                };
                            },
                            resolveScrollElement: function (a, b) {
                                ...
                                if (d && k.contains(d)) {
                                    ...
                                    if (a.scrollIfNeeded) {
                                        ...
                                        var f =
                                            (d.bottom - k.top - b.stageHeight) /
                                                b.scale +
                                            b.margin.top;
                                        if (
                                            Math.min(c, f) > b.scrollY ||
                                            Math.max(c, f) < b.scrollY
                                        )
                                            a.scrollY =
                                                Math.abs(b.scrollY - c) <
                                                Math.abs(b.scrollY - f)
                                                    ? c
                                                    : f;
                                        c = (d.left - k.left) / b.scale;
                                        d =
                                            (d.right - k.left - b.stageWidth) /
                                                b.scale +
                                            b.margin.left;
                                        if (
                                            Math.min(c, d) > b.scrollX ||
                                            Math.max(c, d) < b.scrollX
                                        )
                                            a.scrollX =
                                                Math.abs(b.scrollX - c) <
                                                Math.abs(b.scrollX - d)
                                                    ? c
                                                    : d;
                                    } else
                                        (a.scrollX =
                                            (d.left - k.left) / b.scale),
                                            (a.scrollY =
                                                (d.top - k.top) / b.scale);
                                }
                            },
                            scrollTo: function (a, b, d) {
                                if (null !== this.currentFrame) {
                                    ...
                                    d = d || {};
                                    d.startPosition &&
                                        (this.currentFrameTransformData = this.currentFrame.getTransformData(
                                            this,
                                            d.startPosition
                                        ));
                            ...
                            setLayerTransform: function (a, b) {
                                ...
                                b &&
                                    b.transition &&
                                    (d = h.timeToMS(b.transition));
                                d = this.inTransition()
                                    ? Math.max(
                                          this.getRemainingTransitionTime(),
                                          d
                                      )
                                    : d;
                            ...
                            gestureListener: function (a) {
                                if (
                                    !a.event._ljEvtHndld ||
                                    a.event._ljEvtHndld === this
                                )
                                    if (
                                        ((a.event._ljEvtHndld = this),
                                        null !== this.currentFrame)
                                    ) {
                                        var b = this._transformer.scrollGestureListener(
                                            a
                                        );
                                        if (!a.first)
                                            if (
                                                ...
                                                (this.inTransition() &&
                                                    (a.preventDefault = !0),
                                                (b = this.currentFrame.neighbors()),
                                                a.direction)
                                            )
                                                if (
                                                    b &&
                                                    b[
                                                        g.directions2neighbors[
                                                            a.direction
                                                        ]
                                                    ]
                                                ) {
                            ...
                            getStageDimensions: function (a) {
                                if (
                                    this._layout &&
                                    this._layout.getStageDimensions
                                )
                                    return this._layout.getStageDimensions(a);
                                if (this.parent)
                                    return {
                            ...
                            showFrame: function (a, b) {
                                if (this.stage)
                                    return (
                                        (b = c._extend(
                                            {
                                                ...
                                                lastFrameName:
                                                    (this.currentFrame &&
                                                        this.currentFrame.name()) ||
                                                    g.specialFrames.none,
                                                applyTargetPrePosition: !1,
                                                applyCurrentPostPosition: this
                                                    .currentFrame
                                                    ? a !==
                                                          this.currentFrame.name() &&
                                                      a !==
                                        ...
                                        this.transitionTo(a, b)
                                    );
                            },
                            noFrameTransformdata: function (a) {
                                if (
                                    this._noframetd &&
                                    this._noframetd.startPosition === a
                                )
                                    return this._noframetd;
                                ...
                                this.stage &&
                                    this.stage.autoHeight() &&
                                    (b.height = b.frameHeight = 0);
                                this.stage &&
                                    this.stage.autoWidth() &&
                                    (b.width = b.frameWidth = 0);
                                b.shiftX = b.shiftY = b.scrollX = b.scrollY = 0;
                                b.isScrollX = b.isScrollY = !1;
                                b.startPosition = a || "top";
                                b.initialScrollX = b.scrollX;
                                b.initialScrollY = b.scrollY;
                                return b;
                            },
                            transitionTo: function (a, b) {
                                ...
                                var f =
                                        b.groupId ||
                                        (b.groupId = h.uniqueID("group")),
                                    k = this.lastgroupId !== f;
                                this.lastgroupId = f;
                                if (b.delay)
                                    b.semaphore && b.semaphore.skip(),
                                        setTimeout(function () {
                                            b.groupId === d.lastgroupId &&
                                                (delete b.semaphore,
                                                delete b.delay,
                                                delete b.transitionID,
                                                d.transitionTo(a, b));
                                        }, h.timeToMS(b.delay));
                                else {
                                    var e = function () {
                                        if (!a && null !== a)
                                            throw "transformTo: no frame given";
                                        ...
                                        b = c._extend(
                                            {
                                                ...
                                                previousType:
                                                    b && b.type
                                                        ? void 0
                                                        : (d.currentFrame &&
                                                              d.currentFrame.defaultTransition()) ||
                                                          void 0,
                                                ...
                                                frame: f,
                                                framename: a,
                                                applyTargetPrePosition:
                                                    (!b.noActivation &&
                                                        (b.applyTargetPrePosition ||
                                                            (f &&
                                                                f.parent &&
                                                                f.parent ===
                                                                    d))) ||
                                                ...
                                                interStage:
                                                    ...
                                                    f.parent &&
                                                    f.parent !== d,
                                                applyCurrentPostPosition:
                                                    (!0 !==
                                                        b.applyCurrentPostPosition &&
                                                        d.currentFrame &&
                                                        d.currentFrame.parent &&
                                                        d.currentFrame
                                                            .parent === d &&
                                                        !b.noActivation) ||
                                                    !1,
                                                applyCurrentPrePosition:
                                                    (!0 !==
                                                        b.applyCurrentPrePosition &&
                                                        d.currentFrame &&
                                                        d.currentFrame.parent &&
                                                        d.currentFrame
                                                            .parent === d &&
                                        ...
                                        b.type &&
                                            b.type.match(/^(?:r:|reverse:)/i) &&
                                            ((b.type = b.type.replace(
                                                /^(?:r:|reverse:)/i,
                                                ""
                                            )),
                                            (b.reverse = !0));
                                        b.previousType &&
                                            b.previousType.match(
                                                /^(?:r:|reverse:)/i
                                            ) &&
                                            ((b.previousType = b.previousType.replace(
                                                /^(?:r:|reverse:)/i,
                                                ""
                                            )),
                                            (b.previousReverse = !0));
                                        b.semaphore ||
                                            (b.semaphore = new c.Semaphore().register());
                                        b.semaphore
                                            .listen(!0)
                                            .then(function (a) {
                                                0 < a &&
                                        ...
                                        b.duration =
                                            Math.max(
                                                d.getRemainingTransitionTime() ||
                                                    0,
                                                h.timeToMS(b.duration) || 0
                                            ) + "ms";
                                        "0ms" === b.duration &&
                                            (b.duration = "");
                                        ...
                                        return d._layout
                                            ...
                                            .then(function () {
                                                var k = d.getCurrentScroll(),
                                                    g = (b.targetFrameTransformData =
                                                        null === f
                                                            ? d.noFrameTransformdata(
                                                                  b.startPosition
                                                              )
                                                            : f.getTransformData(
                                                                  d,
                                                ...
                                                b.scrollElement &&
                                                    d.resolveScrollElement(
                                                        b,
                                                        g
                                                    );
                                                var e = d._transformer.getScrollTransform(
                                                    g,
                                                    b,
                                                    !0
                                                );
                                                ...
                                                f && (f.inTransition = !0);
                                                k = d._layout
                                                    .transitionTo(f, b, g, e)
                                                    .then(function () {
                                                        d._transitionEnd(b);
                                                    });
                                                b.noActivation ||
                                                    ((d.currentFrameTransformData = g),
                                                    (d.currentFrame = f),
                                                    (d.currentTransform = e));
                                                d.trigger(
                                                    "transitionStarted",
                                                    a,
                                                    b
                            ...
                            _transitionEnd: function (a) {
                                var b = this;
                                a.transitionID === this.transitionID &&
                                    (h.debug(
                                        "transition finished",
                                        a.transitionID
                                    ),
                                    a.noActivation ||
                                        (this.currentTransform = this._transformer.getScrollTransform(
                                            a.targetFrameTransformData || {},
                                            a,
                                            !1
                                        )),
                                    this.inTransition(!1),
                                    ...
                                    this.updateClasses(),
                                    a.frame && (a.frame.inTransition = !1),
                            ...
                            _getFrame: function (a, b) {
                                if (
                                    a === g.specialFrames.left ||
                                    a === g.specialFrames.right ||
                                    a === g.specialFrames.top ||
                                    a === g.specialFrames.bottom
                                )
                                    if (null !== this.currentFrame) {
                                        var c = this.currentFrame.neighbors();
                                        b = b || {};
                                        c && c.l && a === g.specialFrames.left
                                            ? (a = c.l)
                                            : c &&
                                              c.r &&
                                              a === g.specialFrames.right
                                            ...
                                            ? (a = c.b)
                                            : b.type !==
                                                  g.neighbors2transition.r ||
                                              a !== g.specialFrames.left ||
                                              ((!c || c.l) && c)
                                            ? b.type !==
                                                  g.neighbors2transition.l ||
                                              a !== g.specialFrames.right ||
                                              ((!c || c.r) && c)
                                                ? b.type !==
                                                      g.neighbors2transition
                                                          .b ||
                                                  a !==
                                                      g.specialFrames.bottom ||
                                                  ((!c || c.u) && c)
                                                    ? b.type !==
                                                          g.neighbors2transition
                                                              .u ||
                                                    ...
                                                    : (a =
                                                          g.specialFrames
                                                              .previous)
                                                : (a = g.specialFrames.previous)
                                            : (a = g.specialFrames.next);
                                    } else
                                        null === this.currentFrame &&
                                            (a !== g.specialFrames.previous
                                                ? (a = g.specialFrames.next)
                                                : a !== g.specialFrames.next &&
                                                  (a =
                                                      g.specialFrames
                                                          .previous));
                                a === g.specialFrames.toggle &&
                                    (a =
                                        null === this.currentFrame
                                            ? g.specialFrames.next
                                            : g.specialFrames.none);
                                a === g.specialFrames.next
                                    ? (a = this._getNextFrameName())
                                    : a === g.specialFrames.previous
                                    ? (a = this._getPreviousFrameName())
                                    : a === g.specialFrames.current &&
                                      (a =
                                          null !== this.currentFrame
                                              ? this.currentFrame.name()
                                              : g.specialFrames.none);
                                if (a === g.specialFrames.none) b = null;
                                    ...
                                    ((b = this.getChildViewByName(a)),
                                    void 0 === b && void 0 !== a)
                                ) {
                                    a = d.getState().resolvePath(a);
                                    if (1 < a.length)
                                        throw "only 1 path should be expected";
                            ...
                            _getNextFrameName: function () {
                                ...
                                if (null === this.currentFrame && 0 < a.length)
                                    var b = a[0].name();
                                else if (
                                    null !== this.currentFrame &&
                                    0 < a.length
                            ...
                            updateClasses: function () {
                                for (
                                    ...
                                    h.removeClass(a[d].outerEl, "lj-active"),
                                        h.removeClass(
                                            a[d].outerEl,
                                            "lj-transition"
                                        );
                            ...
                            render: function () {
                                ...
                                for (var c = 0; c < b; c++) {
                                    var f = a[c];
                                    void 0 !== f.transformData &&
                                        (f.transformData.isDirty = !0);
                                }
                            ...
                            _parseChildren: function (a) {
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        a.addedNodes[c]._ljView &&
                                            b.push(a.addedNodes[c]._ljView);
                                }
                                a = function (a) {
                                    d.currentFrame &&
                                        null !== d.currentFrame &&
                                        d.currentFrame.name() === a &&
                                        (d._renderChildPosition(
                                            d._cache.childNames[a]
                                        ),
                                        d.render());
                                };
                                for (c = 0; c < b.length; c++)
                                    b[c].on("renderRequired", a, {
                                        context: this,
                                    });
                            },
                        },
                        {
                            defaultProperties: { type: "layer" },
                            identify: function (a) {
                                a = h.getAttributeLJ(a, "type");
                                return (
                                    null !== a &&
                                    a.toLowerCase() === n.defaultProperties.type
                                );
                            },
                        }
                    );
                ...
                e = f.extend({
                    ...
                    transitionTo: function (b, a, f, e) {
                        var d = new c.Promise(),
                            ...
                            l = function (b, d) {
                                ...
                                d.width = c.applyWidth
                                    ? c.frameWidth -
                                      c.margin.left -
                                      c.margin.right +
                                      "px"
                                    : c.frameOriginalWidth;
                                d.height = c.applyHeight
                                    ? c.frameHeight -
                                      c.margin.top -
                                      c.margin.bottom +
                                      "px"
                                    : c.frameOriginalHeight;
                                g._applyTransform(b, g._reverseTransform, e, d);
                            },
                            m = g.layer.currentFrame;
                        if (m && m.transformData.isDirty) {
                            g._reverseTransform = g._calculateReverseTransform(
                                m,
                                m.getTransformData(g.layer, void 0, !0)
                            );
                            for (m = 0; m < h; m++) l(k[m], "none");
                            for (m = 0; m < h; m++)
                                window.getComputedStyle(k[m].outerEl);
                        }
                        var r = a.noActivation ? b : k[h - 1],
                            t = function () {
                                if (a.transitionID === g.layer.transitionID)
                                    for (
                                        var c = 0;
                                        c < (a.noActivation ? 1 : h);
                                        c++
                                    )
                                        (p = a.noActivation ? b : k[c]),
                                            p.applyStyles({
                                                transition: "none",
                                            });
                                d.resolve();
                    ...
                    _calculateReverseTransform: function (b, a) {
                        ...
                        this._currentRotation &&
                            (d > this._currentRotation + 180 &&
                                (d -=
                                    360 *
                                    (1 +
                                        Math.floor(
                                            (d - this._currentRotation) / 360
                                        ))),
                            d < this._currentRotation - 180 &&
                                (d +=
                                    360 *
                                    (1 +
                                        Math.floor(
                                            (this._currentRotation - d) / 360
                                        ))));
                        this._currentRotation = d;
                        return (
                            "translate3d(" +
                            parseInt(-a.shiftX, 10) +
                            "px," +
                            parseInt(-a.shiftY, 10) +
                            "px,0px) scale(" +
                            a.scale / (b.scaleX() || 1) +
                            "," +
                            a.scale / (b.scaleY() || 1) +
                    ...
                    setLayerTransform: function (b, a) {
                        var f = this.layer.getChildViews(),
                            ...
                            d = new c.Promise();
                        a.transition
                            ? this.layer.currentFrame.outerEl.addEventListener(
                                  "transitionend",
                                  function z(a) {
                                      a.target.removeEventListener(a.type, z);
                                      d.resolve();
                                  }
                              )
                            : d.resolve();
            ...
            function (e, m, l) {
                ...
                e = c.EventManager.extend({
                    ...
                    loadFrame: function (b) {
                        ...
                        if (
                            null === b ||
                            (b.document.body.contains(b.outerEl) &&
                                "none" !== g(b.outerEl).display &&
                                b.parent === this.layer)
                        )
                            a.resolve();
                            ...
                            g = e.invert().prod(n);
                            b.parent.currentFrame === b &&
                                (b.parent.currentFrame = null);
                            ...
                            (b.outerEl.style.display = "block"),
                                (b.outerEl.style.opacity = "0"),
                                a.resolve();
                        return a;
                    },
        ...
        12: [
            function (e, m, l) {
                ...
                var a = ["adjacent", 1, 0, 1, 0],
                    ...
                    k = ["adjacent", 0, 0, 0.666, 0, { opacity: 0 }],
                    q = ["adjacent", 0, 0, 1.5, 0, { opacity: 0 }],
                    y = {
                        default: [a, e, 1],
                        none: [b, b, 1],
                        left: [a, e, 1],
                ...
                e = f.extend({
                    ...
                    hideOtherFrames: function (a, b) {
                        for (
                            var d = this.layer.getChildViews(), c = 0;
                            c < d.length;
                            c++
                        )
                            d[c] !== b &&
                                d[c] !== a &&
                                null !== d[c].outerEl.parentNode &&
                                d[c].applyStyles({ display: "none" });
                    },
                    transitionTo: function (a, b, d, f) {
                        var g = this,
                            e = g.layer.currentFrame;
                        return this.prepareTransition(a, b, d, f).then(
                            function (k) {
                                var n = new c.Promise(),
                                    p = 0,
                                    q = function (a, d) {
                                ...
                                b.semaphore.sync().then(function () {
                                    ...
                                    a &&
                                        "" !== b.duration &&
                                        (a.outerEl.addEventListener(
                                            "transitionend",
                                            function A(d) {
                                                d.target === a.outerEl &&
                                                    (d.target.removeEventListener(
                                                        d.type,
                                                        A
                                                    ),
                                                    q(a, !!b.noActivation));
                                    ...
                                    b.noActivation
                                        ...
                                        : g._applyTransform(
                                              a,
                                              (g._currentFrameTransform = k.t1),
                                              f,
                                              c
                                          );
                                    h.debug("slidelayout: apply t1");
                                    !1 !== b.applyCurrentPostPosition &&
                                        (e && (e.transitionID = b.transitionID),
                                        e &&
                                            "" !== b.duration &&
                                            (e.outerEl.addEventListener(
                                                "transitionend",
                                                function A(a) {
                                                    a.target === e.outerEl &&
                                                        (a.target.removeEventListener(
                    ...
                    prepareTransition: function (a, d, f, g) {
                        var e = new c.Promise(),
                            k,
                            n = this.layer.currentFrame;
                        d.wasInTransition || this.hideOtherFrames(a, n);
                        a &&
                            (k = this._preparedTransitions[a.id()]) &&
                            (k.transform === g && k.applied
                                ? e.resolve(k)
                                : (k = void 0));
                        if (!k) {
                            var p = y[d.type];
                            !p && d.type && d.type.match(/:/)
                                ? (p = d.type.split(":"))
                                : p || (p = [b, b, 1]);
                            if ("function" === typeof p)
                                ...
                                if (d.previousType) {
                                    var q = y[d.previousType];
                                    Array.isArray(q) &&
                                        (p[1] = d.previousReverse
                                            ? q[1]
                                            : q[0]);
                                }
                            ...
                            k.transform = g;
                            if (
                                !1 === d.applyTargetPrePosition &&
                                !1 === d.applyCurrentPrePosition
                            )
                                return e.resolve(k), e;
                            if (null === a && !k.current_css)
                                return (k.applied = !0), e.resolve(k), e;
                            g = { transition: "none", visibility: "inital" };
                            g.width = f.applyWidth
                                ? f.frameWidth -
                                  f.margin.left -
                                  f.margin.right +
                                  "px"
                                : f.frame.getOriginalWidth() + "px";
                            f.applyHeight &&
                                (g.height =
                                    f.frameHeight -
                                    f.margin.top -
                            ...
                            n &&
                                ...
                                (this._applyTransform(
                                    ...
                                    k.c0,
                                    this.layer.currentTransform,
                                    { transition: "none", "z-index": "initial" }
                                ),
            ...
            function (e, m, l) {
                ...
                e = h.EventManager.extend({
                    ...
                    _domElementChanged: function (c) {
                        0 < Object.getOwnPropertyNames(c.attributes).length &&
                            this.trigger("attributesChanged", c.attributes);
                    ...
                    observe: function (f, b) {
                        this.unobserve();
                        var a = this;
                        if (b.attributes || b.children)
                            (this._observer = c.getObserver(f, {
                        ...
                        b.size &&
                            ((this._sizeObserver = c.getSizeObserver(f, {
                                timeout: b.timeout,
                                callback: function () {
                    ...
                    isObserving: function () {
                        return (
                            (void 0 !== this._observer &&
                                this._observer.isObserving()) ||
                            (void 0 !== this._sizeObserver &&
                                this._sizeObserver.isObserving())
                        );
                    },
                });
                m.exports = e;
            ...
            function (e, m, l) {
                ...
                e = h.extend({
                    ...
                    _initalizeAttributes: function () {
                        this.attributes = {};
                        for (
                            var c = this.element.attributes.length, f = 0;
                            f < c;
                            f++
                        ) {
                    ...
                    _invokeCallBack: function (c) {
                        if (
                            ...
                            for (b in c.attributes)
                                if (c.attributes.hasOwnProperty(b))
                                    for (
                                        var a = b.toUpperCase(), g = 0;
                                        g < this.options.attributeFilter.length;
                                        g++
                                    ) {
                                        var e = this.options.attributeFilter[
                                                g
                                            ].toUpperCase(),
                                            d =
                                                e === a ||
                        ...
                        this.options.callback &&
                            ((c.attributes &&
                                0 <
                                    Object.getOwnPropertyNames(c.attributes)
                                        .length) ||
                                (c.addedNodes && 0 < c.addedNodes.length) ||
                                (c.removedNodes && 0 < c.removedNodes.length) ||
                                c.characterData) &&
                ...
                e = h.extend({
                    constructor: function (c, f) {
                        ...
                        this.mutationObserver = new (
                            ...
                            c.ownerDocument.parentWindow
                        ).MutationObserver(function (a) {
                    ...
                    mutationCallback: function (c) {
                        for (
                            ...
                            this.options.attributes &&
                                "attributes" === a.type &&
                                ((f.attributes[a.attributeName] = {
                                    oldValue: this.attributes[a.attributeName],
                                    newValue: this.element.getAttribute(
                                        a.attributeName
                                    ),
                                }),
                                (this.attributes[a.attributeName] =
                                    f.attributes[a.attributeName].newValue));
                            if (
                                ...
                                if (a.addedNodes && 0 < a.addedNodes.length)
                                    for (
                                        var g = 0;
                                        g < a.addedNodes.length;
                                        g++
                                    )
                                        f.addedNodes.push(a.addedNodes[g]);
                                if (a.removedNodes && 0 < a.removedNodes.length)
                                    for (g = 0; g < a.removedNodes.length; g++)
                                        f.removedNodes.push(a.removedNodes[g]);
                            }
                        }
                    ...
                    observe: function () {
                        ...
                        0 === this.counter &&
                            ...
                            this.mutationObserver.observe(this.element, {
                                ...
                                childList: this.options.childList || !1,
            ...
            function (e, m, l) {
                ...
                e = h.extend({
                    ...
                    checkSize: function () {
                        ...
                        c = c.clientHeight;
                        if (
                            a !== this.dimensions.size.width ||
                            c !== this.dimensions.size.height ||
                            f !== this.dimensions.size_inner.width ||
                            b !== this.dimensions.size_inner.height
                        )
                            (this.dimensions.size = { width: a, height: c }),
                ...
                e = h.extend({
                    ...
                    elementModified: function () {
                        ...
                        if (
                            ...
                            for (f in this.attributes)
                                this.attributes.hasOwnProperty(f) &&
                                    (b[f] = !1);
                            for (
                                var a = 0;
                                a < this.element.attributes.length;
                                a++
                            ) {
                            ...
                            for (f = 0; f < this.childNodes.length; f++)
                                (b = this.childNodes[f]),
                                    this.element.contains(b) ||
                                        (this.childNodes.splice(f, 1),
                                        c.removedNodes.push(b));
                            for (f = 0; f < this.element.childNodes.length; f++)
                                (b = this.element.childNodes[f]),
                                    -1 === this.childNodes.indexOf(b) &&
                                        (c.addedNodes.push(b),
                                        this.childNodes.push(b));
                        }
                        this.options.characterData &&
                            3 === this.element.nodeType &&
                    ...
                    observe: function () {
                        ...
                        if (0 === this.counter) {
                            ...
                            this.myTimeout = void 0;
                            for (
                                var c = this.element.childNodes.length, f = 0;
                                f < c;
                                f++
                            )
                                this.childNodes.push(
                                    this.element.childNodes[f]
                                );
                            var b = this;
                            this.myTimeout = setTimeout(function () {
                                b.elementModified();
                ...
                layerJS.parseManager = new (function () {
                    ...
                    this._parse = function (b, a, g) {
                        ...
                        for (var d = layerJS.getState(a), n = 0; n < e; n++) {
                            var k = h.createView(
                                c.getAttributeLJ(b[n], "type"),
                                f._extend(g, { el: b[n], document: a })
                            );
                            d.registerView(k);
                        }
                    };
            ...
            function (e, m, l) {
                ...
                e = h.EventManager.extend({
                    ...
                    createView: function (c, f) {
                        ...
                        if ("string" === typeof c && this.map.hasOwnProperty(c))
                            return new this.map[c].view(f);
                        throw (
                            "no constructor found for objects of type '" +
                            c +
                            "'"
                        );
                    },
                    registerType: function (c, f, b) {
                        ...
                        void 0 === this.identifyPriorities[b] &&
                            (this.identifyPriorities[b] = []);
                        this.identifyPriorities[b].push(f);
                    },
                    identify: function (c) {
                        for (
                            var f,
                                b = Object.keys(this.identifyPriorities).sort(
                                    function (a, b) {
                                        return -1 * (a - b);
                                    }
                                ),
                            ...
                            for (
                                var g = b[a], e = 0;
                                e < this.identifyPriorities[g].length;
                                e++
                            )
                                if (this.identifyPriorities[g][e].identify(c)) {
                                    f = this.identifyPriorities[g][e]
                        ...
                        if (void 0 === f)
                            throw "no ViewType found for element '" + c + "'";
                        return f;
                    },
                });
            ...
            function (e, m, l) {
                ...
                e = b.extend({
                    constructor: function (a) {
                        ...
                        b.call(this, a);
                        a.cacheCurrent &&
                            ((a = f.splitUrl(window.location.href)),
                            (a.queryString = f.parseStringForTransitions(
                                a.queryString,
                                !0
                            ).string),
                            this.addRoute(f.joinUrl(a, !0), {
                    ...
                    handle: function (a) {
                        ...
                        b.prototype.handle.call(this, a).then(function (b) {
                            b.handled || b.optout
                                ? p.resolve(b)
                                : e._loadHTML(f.joinUrl(a, !0)).then(
                                      function (b) {
                                          c.parseDocument(b);
                                          var d = {},
                                              g = e._state;
                                          g.exportStructure().forEach(function (
                                              a
                                          ) {
                                              a = a.replace(/\$$/, "");
                                              d[a] = {};
                                          ...
                                          var n = layerJS.getState(b),
                                              m = [];
                                          n.exportStructure().forEach(function (
                                              a
                                          ) {
                                              a = a.replace(/\$$/, "");
                                              if (
                                                  ...
                                                  if (d[c] || b) {
                                                      ...
                                                      b.lastChild.style.display =
                                                          "none";
                                                      f = b.lastChild.getElementsByTagName(
                                                          "script"
                                                      );
                                                      for (
                                                          b = 0;
                                                      ...
                                                      throw (
                                                          "filerouter: didn't find '" +
                                                          c +
                                                          "' in current document to add new '" +
                                                          a +
                                                          "'"
                                                      );
                                              }
                                          ...
                                          0 === m.length &&
                                              console.warn(
                                                  "layerJS: filerouter: loaded new document '" +
                                                      f.joinUrl(a, !0) +
                                                      "' but didn't add any new content. You should give the frame that should be added a different name or id."
                                              );
                                          var l = n.exportState(),
                ...
                e = h.EventManager.extend({
                    handle: function (f) {
                        ...
                        if (
                            ...
                            b.resolve({ handled: !1, stop: !1, paths: [] });
                        else {
                            for (
                                var a = (f.hash.startsWith("#")
                                        ? f.hash.substr(1)
                                        : f.hash
                                    ).split(";"),
                                    e = [],
                                ...
                                try {
                                    for (
                                        var B = d.resolvePath(q), r = 0;
                                        r < B.length;
                                        r++
                                    ) {
                                        var t = B[r];
                                        t.hasOwnProperty("frameName") &&
                                            t.hasOwnProperty("layer") &&
                                            (e.push(t.path),
                                            p.push(
                                                h._extend(
                                                    f.globalTransition,
                                ...
                                if (
                                    !l &&
                                    (l =
                                        ((l = document.getElementsByName(q)) &&
                                            l[0]) ||
                                        document.getElementById(q)) &&
                                    "none" !==
                                        window.getComputedStyle(l).display &&
                                    ((r = c.findParentViewOfType(l, "frame")),
                                    void 0 !== r)
                                ) {
                                    ...
                                    if (-1 !== v) var w = p[v];
                                        ...
                                        -1 === v &&
                                        ((u = u.replace(/\.[^\.]*$/, "")),
                                        (u = f.paths.filter(n(u))),
                                        1 === u.length)
                                    ) {
                                        var x = d.resolvePath(u[0])[0].view;
                                        if (
                                            (q =
                                                (q = x.outerEl.querySelectorAll(
                                                    "[name=" + q + "], #" + q
                                                )) && q[0]) &&
                                            "none" !==
                                            ...
                                            C &&
                                                ((x.outerEl.style.opacity = 0),
                                                (x.outerEl.style.display = ""));
                                            l = q;
                                            ...
                                            C &&
                                                ((x.outerEl.style.display =
                                                    "none"),
                                                (x.outerEl.style.opacity = 1));
                                        }
                                    }
                                    -1 === v &&
                                        r.parent.currentFrame === r &&
                                        (e.push(d.buildPath(r.outerEl, !1)),
                                        (w = h._extend(
                                            {},
                                            f.globalTransition,
                                            m.transition
                                        ...
                                        p.push(w));
                                    w &&
                                        ((w.scrollY = l.offsetTop),
                                        (w.scrollX = l.offsetLeft));
                                }
                            }
                            b.resolve({
                                stop: !1,
                ...
                e = f.EventManager.extend({
                    ...
                    _registerLinkClickedListener: function () {
                        ...
                        window.onpopstate = function (b) {
                            document.location.href === a.ignoreUrl
                                ? delete a.ignoreUrl
                                : b && b.state && b.state.state
                                ? a.state.transitionTo(
                                      b.state.state,
                                      b.state.transitions,
                                      { noHistory: !0 }
                                  )
                        ...
                        c.addDelegtedListener(
                            this.rootElement,
                            "click",
                            "a:not([data-lj-no-link='true']):not([lj-no-link='true'])",
                            function (b) {
                                var f = function (b) {
                                    b ||
                                        setTimeout(function () {
                    ...
                    navigate: function (a, b, e, d) {
                        ...
                        if (g.location || g.queryString)
                            (g.explLoc = !0),
                                f._extend(g, c.splitUrl(c.getAbsoluteUrl(a)));
                        if (
                            (b =
                                g.queryString &&
                                c.parseStringForTransitions(g.queryString, !1))
                        )
                            (g.globalTransition = b.transition),
                                (g.queryString = b.string);
                        var k = this.routers.length,
                            ...
                            r = function (a) {
                                a < k
                                    ? h.routers[a].handle(g).then(function (b) {
                                          b.handled &&
                                              ((l = b.handled),
                    ...
                    _stateChanged: function (a, b) {
                        ...
                        a = e.state
                            .concat(e.omittedState)
                            .concat(e.defaultState)
                            .filter(function (a) {
                                return (
                                    0 > b.state.indexOf(a) &&
                                    b.state.indexOf(a.replace("$"))
                                );
                            });
                        a = b.state.concat(a);
                        var d = b.transitions;
                        e = f._extend(c.splitUrl(window.location.href), e);
                        e.queryString = c.parseStringForTransitions(
                            e.queryString,
                            !1
                        ).string;
                        for (var g = 0; g < this.routers.length; g++)
                            this.routers[g].buildUrl(e);
                        g = c.joinUrl(e);
                        !window.history ||
                        (b && b.noHistory) ||
                        window.location.href === g
                            ? !window.history ||
                              (b && b.noHistory && !b.initial) ||
                              (window.history.replaceState(
                                  { state: a, transitions: d },
                                  "",
                                  g
                              ),
            ...
            function (e, m, l) {
                ...
                e = h.EventManager.extend({
                    ...
                    addRoute: function (f, b, a) {
                        ...
                        (a && this.routes.hasOwnProperty(f)) ||
                            (this.routes[f] = b);
                    },
                    hasRoute: function (f) {
                        f = c.getAbsoluteUrl(f);
                    ...
                    handle: function (f) {
                        var b = c.joinUrl(f, !0),
                            a =
                                ...
                                (!f.explLoc &&
                                    c.joinUrl(
                                        c.splitUrl(window.location.href),
                                        !0
                                    ) === b);
                    ...
                    buildUrl: function (f) {
                        ...
                        for (e in this.routes)
                            if (
                                this.routes.hasOwnProperty(e) &&
                                this.routes[e].state.length > k
                            ) {
                                var q = b.filter(d),
                                    l = q.length;
                                l > k && ((n = q), (k = l), (h = e));
                            }
                        this.routes.hasOwnProperty(h) &&
                            this.routes[h].pageTitle &&
                            (f.pageTitle = this.routes[h].pageTitle);
                        h = c.splitUrl(h);
                        f.location = h.location;
                        f.queryString = h.queryString;
                        n.forEach(function (a) {
                            var b = f.state.indexOf(a);
                            -1 !== b
                                ? f.state.splice(b, 1)
                                : f.defaultState.splice(
                                      f.defaultState.indexOf(a),
                                      1
                                  );
                        });
                    },
            ...
            function (e, m, l) {
                ...
                e = h.EventManager.extend({
                    constructor: function (c) {
                        ...
                        this.layer = c;
                        this.layer.outerEl.addEventListener(
                            "scroll",
                            function () {
                                if (b.layer.nativeScroll()) {
                                    var a = b.layer.currentFrameTransformData;
                                    a.scrollX =
                                        b.layer.outerEl.scrollLeft / a.scale;
                                    a.scrollY =
                                        b.layer.outerEl.scrollTop / a.scale;
                    ...
                    _detectInnerScrolling: function (c) {
                        for (
                            ...
                            b &&
                            this.layer.innerEl.contains(b) &&
                            b !== this.layer.innerEl;
                                ...
                                if (
                                    ...
                                    !(
                                        window.getComputedStyle(b)[
                                            "overflow-x"
                                        ] in { visible: 1, hidden: 1 }
                                    ) &&
                                    ((0 < c.shift.x && 0 < b.scrollLeft) ||
                                        b.scrollLeft <
                                            b.scrollWidth - b.clientWidth)
                                )
                                    return c.event.stopPropagation(), !0;
                            } else if (
                                b.clientHeight < b.scrollHeight &&
                                !(
                                    window.getComputedStyle(b)["overflow-y"] in
                                    { visible: 1, hidden: 1 }
                                ) &&
                                ((0 < c.shift.y && 0 < b.scrollTop) ||
                                    b.scrollTop <
                    ...
                    scrollGestureListener: function (c) {
                        ...
                        if (c.first)
                            return (
                                (this.scrollStartX = b.scrollX),
                                (this.scrollStartY = b.scrollY),
                                !0
                            );
                        if (this._detectInnerScrolling(c)) return !0;
                        var a =
                            Math.abs(c.shift.x) > Math.abs(c.shift.y)
                                ? "x"
                                : "y";
                        if (
                            ("x" === a && !b.isScrollX) ||
                        ...
                        if (this.layer.nativeScroll()) {
                            if (10 > Math.abs(c.shift.x) + Math.abs(c.shift.y))
                                return !0;
                            if ("y" === a)
                                return 0 < c.shift.y
                                    ? 0 < b.scrollY
                                    : this.layer.outerEl.scrollHeight -
                                          this.layer.outerEl.clientHeight -
                                          1 >
                                          this.layer.outerEl.scrollTop;
                            if ("x" === a)
                                return 0 < c.shift.x
                                    ? 0 < b.scrollX
                                    : this.layer.outerEl.scrollWidth -
                                          this.layer.outerEl.clientWidth -
                                          1 >
                                          this.layer.outerEl.scrollLeft;
                        } else {
                            if ("y" === a)
                                if (0 < c.shift.y) {
                                ...
                                } else if (1 > b.maxScrollX - b.scrollX)
                                    return !1;
                            ...
                            b.scrollX > b.maxScrollX &&
                                (b.scrollX = b.maxScrollX);
                            0 > b.scrollY && (b.scrollY = 0);
                            b.scrollY > b.maxScrollY &&
                                (b.scrollY = b.maxScrollY);
                            return this.scrollTransform(
                                -b.scrollX * b.scale,
                                -b.scrollY * b.scale
                            );
                        }
                    ...
                    getScrollTransform: function (e, b, a) {
                        ...
                        a ||
                            ((f = b.scrollX || e.initialScrollX),
                            (h = b.scrollY || e.initialScrollY));
                        ...
                        if (this.layer.nativeScroll()) {
                            if (a)
                                return (
                                    (a = b = 0),
                                    (b =
                                        (this.layer.outerEl.scrollLeft || 0) -
                                        (e.scrollX * e.scale || 0)),
                                    (a =
                                        (this.layer.outerEl.scrollTop || 0) -
                                        (e.scrollY * e.scale || 0)),
                                    this.scrollTransform(b, a)
                                );
                            this.layer.innerEl.style.height = e.isScrollY
                                ? e.height + "px"
                                : "100%";
                            this.layer.innerEl.style.width = e.isScrollX
                                ? e.width + "px"
                                : "100%";
                            this.layer.outerEl.scrollLeft = e.scrollX * e.scale;
                            this.layer.outerEl.scrollTop = e.scrollY * e.scale;
                            if ("ios" === c.browser) {
                                this.layer.outerEl.style[
                                    "-webkit-overflow-scrolling"
                                ] = "auto";
                                var d = this;
                                setTimeout(function () {
                                    d.layer.outerEl.style[
                                        "-webkit-overflow-scrolling"
                                    ] = "touch";
                                }, 1);
                            }
                    ...
                    a = b.extend(
                        {
                            ...
                            _renderChildPosition: function (a) {
                                1 === a.nodeType() &&
                                    (a.unobserve(),
                                    (a.outerEl.style.left = "0px"),
                                    (a.outerEl.style.top = "0px"),
                                    a.startObserving());
                            },
                            _parseChildren: function (a) {
                                var c = this,
                                ...
                                if (d) {
                                    ...
                                    for (
                                        var f = 0;
                                        f < this._cache.children.length;
                                        f++
                                    )
                                        this._cache.children[f].name() === d &&
                                            (this._cache.children[f].on(
                                                "transitionStarted",
                                                e(this._cache.children[f])
                                            ),
                                            (a = this._cache.children[f]));
                                    !a &&
                                        this._cache.children[0] &&
                                        (this._cache.children[0].on(
                                            "transitionStarted",
                                            e(this._cache.children[0])
                                        ),
                        ...
                        {
                            defaultProperties: { type: "stage" },
                            identify: function (b) {
                                b = f.getAttributeLJ(b, "type");
                                return (
                                    null !== b &&
                                    b.toLowerCase() === a.defaultProperties.type
                                );
                            },
                        }
                    );
                    ...
                    f = h.EventManager.extend({
                        ...
                        registerView: function (b) {
                            if (b.document.body.contains(b.outerEl)) {
                                var a = b.id();
                                if (this.views[a]) {
                                    if (this.views[a].view !== b)
                                        throw (
                                            "state.registerView: duplicate HTML id '" +
                                            a +
                                            "'"
                                        );
                                } else {
                                    ...
                                    var e = this;
                                    this.getTrailingPaths(c).forEach(function (
                                        b
                                    ) {
                                        (e.paths[b] = e.paths[b] || []).push(a);
                                    });
                                    ...
                                    b.on(
                                        ...
                                        function (a, b) {
                                            ...
                                            if (
                                                !b ||
                                                b.lastFrameName !== a ||
                                                (b.hasOwnProperty("groupId") &&
                                                    this._transitionGroup.hasOwnProperty(
                                                        b.groupId
                                                    ))
                                            )
                                                b &&
                                    ...
                                    b.on(
                                        "attributesChanged",
                                        this._attributesChangedEvent(b),
                                        { context: this }
                                    );
                        ...
                        unregisterView: function (b) {
                            var a = b.id(),
                                c = this;
                            this.getTrailingPaths(this.views[a].path).forEach(
                                function (b) {
                                    var d = c.paths[b].indexOf(a);
                        ...
                        _exportState: function (b) {
                            ...
                            c.exportStructure("frame").forEach(function (e) {
                                ...
                                if (1 < f.length)
                                    throw (
                                        "state.exportState: multiple frames found for " +
                                        e
                                    );
                                f = c.views[f[0]].view;
                                var g = f.parent;
                                f === g.currentFrame
                                    ? !0 === b && g.noUrl()
                                        ? a.omittedState.push(e)
                                        : !0 === b &&
                                          (g.currentFrame.name() ===
                                              g.defaultFrame() ||
                                              (null === g.defaultFrame() &&
                                                  null ===
                                                      g.currentFrame.outerEl
                                                          .previousElementSibling))
                                        ? a.defaultState.push(e)
                                        : a.state.push(e)
                                    : d && f.parent !== f.originalParent
                                    ? a.state.push(e)
                                    : d && a.omittedState.push(e);
                            });
                            this.layers
                                .map(function (a) {
                        ...
                        exportStructure: function (b) {
                            ...
                            return e.map(function (b) {
                                var d = !0;
                                "frame" === b._ljView.type() &&
                                    ((d = b._ljView),
                                    (d = d.parent.currentFrame === d));
                                return (
                                    a.views[b._ljView.id()].path +
                                    (d ? "" : "$")
                                );
                            });
                        },
                        ...
                        _transitionTo: function (b, a, e, f) {
                            ...
                            a.map(function (a) {
                                ...
                                for (var d = 0; d < a.length; d++) {
                                    ...
                                    var n = h._extend(
                                        q,
                                        e[Math.min(b, e.length - 1)] || {}
                                    );
                                    !0 !== c.noActivation &&
                                        (c.isInterStage &&
                                            g.hasOwnProperty(c.originalPath) &&
                                            l(c.originalPath),
                                        g.hasOwnProperty(c.path) && l(c.path),
                                        k.hasOwnProperty(f) && l(k[f]),
                                        (k[f] = c.path));
                                    if (!0 !== c.noActivation || c.isInterStage)
                                        g[c.path] = {
                                            layer: c.layer,
                            ...
                            var m = new h.Semaphore(a.length),
                                p = c.uniqueID("group");
                            this._transitionGroup[p] = {
                                length: a.length,
                                payload: f,
                            };
                            for (f = 0; f < a.length; f++) {
                                var r = g[a[f]];
                                r.transition.semaphore = m;
                                r.transition.groupId = p;
                                b
                                    ? r.layer.showFrame(
                                          r.frameName,
                                          r.transition
                                      )
                                    : r.layer.transitionTo(
                                          r.frameName,
                                          r.transition
                                      );
                            }
                        ...
                        buildPath: function (b, a) {
                            ...
                            a =
                                !a && c
                                    ? this.views[c.id()].path
                                    : this.buildPath(b.parentNode);
                            "" !== a && (a += ".");
                        ...
                        resolvePath: function (b, a) {
                            ...
                            if (1 < d.length && e) {
                                for (var h = []; 0 === h.length && e; ) {
                                    for (k = 0; k < d.length; k++)
                                        this.views[d[k]].path.startsWith(e) &&
                                            h.push(d[k]);
                                    e = e.replace(/\.?[^\.]$/, "");
                                }
                                d = h.length ? h : d;
                            ...
                            for (k = 0; k < d.length; k++) {
                                ...
                                if (f) {
                                    if ("layer" !== h.type())
                                        throw (
                                            "state: expected layer name in front of '" +
                                            a +
                                            "'"
                                        );
                                    e.push({
                                    ...
                                    e.push({
                                        ...
                                        path: l + (c ? "$" : ""),
                                        active:
                                            void 0 !== h.parent.currentFrame &&
                                            null !== h.parent.currentFrame
                                                ? h.parent.currentFrame.name() ===
                                                  a
                                                : !1,
                                        noActivation: c,
                                    });
                                    ...
                                    if (l.endsWith(b))
                                        e.push({ view: h, path: l });
                                    else {
                                        var m = this.resolvePath(a);
                                        1 === m.length &&
                                            e.push({
                                                layer: h,
                                                frameName: a,
                        ...
                        _attributesChangedEvent: function (b) {
                            var a = this;
                            return function (c) {
                                if (c["lj-name"] || c["data-lj-name"] || c.id)
                                    a.unregisterView(b), a.registerView(b);
                            };
                        },
                    });
        ...
        30: [
            function (e, m, l) {
                ...
                h.prototype = {
                    prod: function (c) {
                        return new h([
                            this.a * c.a + this.b * c.c,
                            this.a * c.b + this.b * c.d,
                            this.c * c.a + this.d * c.c,
                            this.c * c.b + this.d * c.d,
                            this.a * c.tx + this.b * c.ty + this.tx,
                            this.c * c.tx + this.d * c.ty + this.ty,
                        ]);
                    },
                    transform: function () {
                        return (
                    ...
                    transform_nomatrix: function (c) {
                        ...
                        return (
                            "scale(" +
                            this.get_scale_equal() +
                            ") rotate(" +
                            (this.get_rotation_equal() + (c ? c : 0)) +
                            "deg) " +
                            h.getTranslateString(e.x, e.y)
                        );
                    },
                    ...
                    invert: function () {
                        var c = 1 / (this.a * this.d - this.b * this.c || 1),
                            e = c * this.d,
                            b = -c * this.b,
                            a = -c * this.c;
                        c *= this.a;
                ...
                (function () {
                    var e = function () {
                        ...
                        var e = function (a) {
                                ...
                                if (null === a)
                                    throw "no object provided in _extend";
                                for (var d = 1; d < b; d++)
                                    for (
                                        var c = Object.keys(arguments[d]),
                                            e = 0;
                                        e < c.length;
                                        e++
                                    )
                                        a[c[e]] = arguments[d][c[e]];
                                return a;
                            },
                            b = function (a) {
                                if ("object" === typeof a) {
                            ...
                            a = {
                                ...
                                _extendKeep: function (a) {
                                    var b = arguments.length;
                                    if (2 > b)
                                        throw "too few arguments in _extend";
                                    if (null === a)
                                        throw "no object provided in _extend";
                                    for (var d = 1; d < b; d++)
                                        for (
                                ...
                                _extendKeepDeepCopy: function (a) {
                                    ...
                                    for (var c = 1; c < d; c++)
                                        for (
                                            var e = Object.keys(arguments[c]),
                                                f = 0;
                                            f < e.length;
                                            f++
                                        )
                                            a.hasOwnProperty(e[f]) ||
                                                (a[e[f]] = b(
                                                    arguments[c][e[f]]
                                                ));
                                    return a;
                        ...
                        g.extend = function (a, b) {
                            ...
                            b = b || {};
                            var d = this,
                                f = a.hasOwnProperty("constructor")
                                    ? a.constructor
                                    : function () {
                        ...
                        a.EventManager = g.extend({
                            ...
                            off: function (a, b, c) {
                                if (a)
                                    ...
                                    for (var e in this.__listeners__) {
                                        if (
                                            this.__listeners__.hasOwnProperty(e)
                                        )
                                            for (
                                                d = this.__listeners__[e],
                                                    a = 0;
                                                a < d.length;
                                                a++
                                            )
                            ...
                            triggerBy: function (a, b) {
                                if (this.__listeners__[b])
                                    for (
                                        var d = 0;
                                        d < this.__listeners__[b].length;
                                        d++
                                    )
                                        if (
                                            !this.__listeners__[b][d].options
                                                .ignoreSender ||
                                            this.__listeners__[b][d].options
                                                .ignoreSender !== a
                                        ) {
                        ...
                        var h = (a.Promise = g.extend({
                            ...
                            resolve: function (a) {
                                if (void 0 !== this.state)
                                    console.warn(
                                        "Promise: double resolve/reject (ignored)."
                                    );
                                else
                                    return (
                                        (this.state = !0),
                            ...
                            execute: function () {
                                if (this.nextPromise) {
                                    ...
                                    if (!0 === this.state) {
                                        if (this.fn)
                                            try {
                                                var b = this.fn(this.value);
                                                b instanceof h
                                                    ? b.then(
                                                          function (b) {
                                                              a.nextPromise.resolve(
                                                                  b
                                                              );
                                                          },
                                                          function (b) {
                                                              a.nextPromise.reject(
                                                                  b
                                                              );
                                                          }
                                                      )
                                                ...
                                                console.log(
                                                    ...
                                                    this.nextPromise.reject(k);
                                            }
                                    } else
                                        !1 === this.state &&
                                            (this.errFn &&
                                                this.errFn(this.reason),
                                            this.nextPromise.reject(
                                                this.reason
                                            ));
                                }
                            },
                        ...
                        a.Semaphore = g.extend({
                            ...
                            skip: function () {
                                this.num--;
                                if (0 > this.num)
                                    throw "semaphore: skipped stakeholder that was not registered";
                                this.num === this.cc &&
                                    (this.cc--, this.sync());
                            },
                            sync: function () {
                                ...
                                if (this.cc === this.num) {
                                    for (var c = 0; c < this.ls.length; c++)
                                        this.ls[c].resolve(this.num);
                                    for (c = 0; c < this.ps.length; c++)
                                        this.ps[c].resolve(this.num);
                                    var e = this;
                                    setTimeout(function () {
                                        for (var a = 0; a < e.ls2.length; a++)
                                            e.ls2[a].resolve(e.num);
                                    }, 0);
                        ...
                        a.Queue = g.extend({
                            ...
                            add: function (b) {
                                ...
                                if (this.waiting) {
                                    var d =
                                        0 < this.q.length &&
                                        b ===
                                            this.q[this.q.length - 1].category;
                                    void 0 !== b &&
                                        d &&
                            ...
                            continue: function () {
                                this.q.length
                                    ? this.q.shift().promise.resolve()
                                    : (this.waiting = !1);
                            },
                            clear: function () {
                                for (; 0 < this.q.length; )
                                    this.q.shift().promise.reject();
                                this.waiting = !1;
                            },
                        });
                        return a;
            ...
            function (e, m, l) {
                ...
                layerJS.init = function () {
                    if (!a) {
                        ...
                        e &&
                            "filerouter" === e.toLowerCase() &&
                            layerJS.router.addRouter(
                                new c({ cacheCurrent: !0 })
                            );
                ...
                "interactive" === document.readyState
                    ? b.getAttributeLJ(document.body, "no-init") ||
                      a ||
                      layerJS.init()
                ...
                console.log(
                    "*** layerJS *** checkout http://layerjs.org *** happy to help you: developers@layerjs.org ***"
                );
            },
            {
