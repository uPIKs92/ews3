! function(e) {
    ...
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">Measure</a>\
  <div class="{{ model.className }}-interaction js-interaction"> \
    <div class="js-startprompt startprompt"> \
      <h6>Measure distances and areas</h6> \
      <ul class=tasks> \
    ...
    <div class=js-measuringprompt> \
      ...
      <ul class="js-measuretasks tasks"> \
        <li>\
          <a href=# class="js-cancel cancel">Cancel</a>\
        </li> \
        <li>\
          <a href=# class="js-finish finish">Finish measurement</a>\
        </li> \
      </ul> \
    </div> \
  </div> '
    ...
    <ul class=tasks> \
      ...
      <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function(e, t, r) {
    e.exports = '\
