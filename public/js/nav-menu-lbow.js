				...
				function fnMaps(event) {
					...
					if (listBtnMaps[id] != '') {
						switch (id) {
							...
							case 2:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[4], listBtnMaps[id]);
								break;
							case 6:
								console.log(id + ' fnMaps called');
								event.stopImmediatePropagation();
								...
								if ($('#input-VK').val() != '') {
									...
									if (count < 4) {
										...
										switch (count) {
											...
											case 3: {
												event.stopImmediatePropagation();
												showToggle(toggLabelE, toggLabelF);
												$('.cursor i').addClass('d-none');
												hideNumBtn('#btnCrecir-', 30, 40);
												return;
											}
				...
				function fnTrack(event) {
					...
					if (listBtnTrack[id] != '') {
						switch (id) {
							...
							case 2:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[6], listBtnTrack[id]);
								break;
							case 5:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[6], listBtnTrack[id]);
				...
				function fnWeapon(event) {
					...
					if (listBtnWeapon[id][0] != '') {
						switch (id) {
							...
							case 2:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[7], listBtnWeapon[id]);
								break;
						}
					}
				}
				...
				function fnRadcon(event) {
					...
					if (listBtnRadcon[id] != '') {
						switch (id) {
							...
							case 1:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[8], listBtnRadcon[id]);
								break;
							case 3:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[8], listBtnRadcon[id]);
				...
				function fnRadplt(event) {
					...
					if (listBtnRadplt[id][0] != '') {
						switch (id) {
							...
							case 2:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnLogon[9], listBtnRadplt[id][0]);
