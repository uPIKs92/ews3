	...
	if (buttonName != '' || buttonName != null) {
		switch (buttonName) {
					...
					if (listBtnLogon[id] != '') {
						switch (id) {
							...
							case 2:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnMain[0][0], listBtnLogon[id]);
								document.getElementById('input-btn-out').innerHTML = '<span class="active">' + listBtnLogon[id] + '</span>';
								$('#input-VK').val('ON');
								break;
							case 3:
								event.stopImmediatePropagation();
							...
							case 14:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnMain[0][0], listBtnLogon[id]);
								document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'pu-' + '</span>';
								$('#input-VK').val('ON');
								break;
							case 18:
								event.stopImmediatePropagation();
							...
							case 22:
								event.stopImmediatePropagation();
								callBtnMenu(id, listBtnMain[0][0], listBtnLogon[id]);
								document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'ew1-' + '</span>';
								$('#input-VK').val('ON');
								break;
							case 24:
								event.stopImmediatePropagation();
					...
					if (listBtnCreftr[id][0] != '') {
						...
						switch (id) {
							...
							case 3:
								console.log(id + ' fnCreftr called');
								event.stopImmediatePropagation()
								showNumBtn('#btnCreftr-', 30, 40, listBtnCreftr, 3);
								hideAlphaBtn('#btnCreftr-');
								break;
							case 4:
								console.log(id + ' fnCreftr called');
					...
					if (listBtnCrecir[id][0] != '') {
						...
						switch (id) {
							case 0:
								...
								setTimeout(function () {
									showNumBtn('#btnCrecir-', 30, 40, listBtnCrecir, 3);
								}, 125);
								break;
							case 1:
								console.log(id + ' fnCrecir called');
					...
					if (listBtnHistry[id][0] != '') {
						...
						switch (id) {
							...
							case 2:
								...
								event.stopImmediatePropagation();
								showNumBtn('#btnHistry-', 30, 40, listBtnHistry, 1);
								break;
							case 40:
							case 42:
								console.log(id + ' fnHistry called');
			...
			case 'trklin': {
				...
				showNumBtn('#btnTrklin-', 30, 40, listBtnTrklin, 1);
				return;
			}
			case 'selreg': {
				let count = 1;
				...
				toggleBtn(1, '#btnSelreg-1', toggLabelA1, toggLabelA2, 'underlined', 'off', 'selreg');
			...
			case 'stbsrc': {
							...
							case 49:
								...
								if ($('#input-VK').val() != '') {
									...
									if (count < 7) {
										...
										if (count < 5) {
											document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'ew' + count + '-' + '</span>';
										} else if (count == 6) {
											document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'all-' + '</span>';
										}
				...
				toggleBtn(1, '#btnStbsrc-1', toggLabelA1, toggLabelA2, 'underlined', 'off', 'ew1-');
				toggleBtn(2, '#btnStbsrc-2', toggLabelB1, toggLabelB2, 'underlined', 'off', 'ew2-');
				toggleBtn(3, '#btnStbsrc-3', toggLabelC1, toggLabelC2, 'underlined', 'off', 'ew3-');
				toggleBtn(4, '#btnStbsrc-4', toggLabelD1, toggLabelD2, 'underlined', 'off', 'ew4-');
				toggleBtn(6, '#btnStbsrc-6', toggLabelE1, toggLabelE2, 'underlined', 'off', 'all-');
				showToggle(toggLabelA1, toggLabelA2);
					...
					if (listBtnAmdreg[id][0] != '') {
						...
						switch (id) {
							case 1:
								...
								event.stopImmediatePropagation();
								showNumBtn('#btnAmdreg-', 30, 40, listBtnAmdreg, 1);
								count = id;
								break;
							case 2:
							case 3:
								console.log(id + ' fnAmdreg called');
								event.stopImmediatePropagation();
								showNumBtn('#btnAmdreg-', 30, 40, listBtnAmdreg, 3);
								count = id;
								break;
							case 4:
							case 5:
								console.log(id + ' fnAmdreg called');
								event.stopImmediatePropagation();
								showNumBtn('#btnAmdreg-', 30, 40, listBtnAmdreg, 4);
								count = id;
								break;
							case 40:
							case 42:
							...
							case 49:
								...
								if ($('#input-VK').val() != '') {
									...
									switch (count) {
										case 1:
											if (($('#input-VK').val() < 1) || ($('#input-VK').val() > 4)) {
											...
											break;
										case 2:
											if (($('#input-VK').val() <= -800) || ($('#input-VK').val() >= 800)) {
											...
											break;
										case 3:
											if (($('#input-VK').val() <= -10) || ($('#input-VK').val() >= 10)) {
			...
			case 'commet': {
						...
						switch (id) {
							...
							case 49:
								...
								if ($('#input-VK').val() != '') {
									...
									if ($('#input-VK').val() < 1 || $('#input-VK').val() > 9) {
				...
				showNumBtn('#btnCommet-', 30, 40, listBtnCommet, 1);
				return;
			}
			case 'pltsel': {
				let count = 1;
							...
							case 49:
								...
								if ($('#input-VK').val() != '') {
									...
									if (count < 7) {
										...
										switch (count) {
											case 2:
												document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'su-' + '</span>';
												break;
											case 3:
												document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'pa-' + '</span>';
												break;
											case 4:
												document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'sa-' + '</span>';
												break;
											case 6:
												changeVKWidth('5.5%', '67%');
												document.getElementById('input-btn-out').innerHTML = '<span class="active">' + 'all-' + '</span>';
				...
				toggleBtn(1, '#btnPltsel-1', toggLabelA1, toggLabelA2, 'underlined', 'off', 'pu-');
				toggleBtn(2, '#btnPltsel-2', toggLabelB1, toggLabelB2, 'underlined', 'off', 'su-');
				toggleBtn(3, '#btnPltsel-3', toggLabelC1, toggLabelC2, 'underlined', 'off', 'pa-');
				toggleBtn(4, '#btnPltsel-4', toggLabelD1, toggLabelD2, 'underlined', 'off', 'sa-');
				toggleBtn(6, '#btnPltsel-6', toggLabelE1, toggLabelE2, 'underlined', 'off', 'all-');
				showToggle(toggLabelA1, toggLabelA2);
			...
			case 'pltsrc': {
				...
				toggleBtn(1, '#btnPltsrc-1', toggLabelA1, toggLabelA2, 'underlined', 'off', 'ew1-');
				toggleBtn(2, '#btnPltsrc-2', toggLabelB1, toggLabelB2, 'underlined', 'off', 'ew2-');
				toggleBtn(3, '#btnPltsrc-3', toggLabelC1, toggLabelC2, 'underlined', 'off', 'ew3-');
				toggleBtn(4, '#btnPltsrc-4', toggLabelD1, toggLabelD2, 'underlined', 'off', 'ew4-');
				toggleBtn(6, '#btnPltsrc-6', toggLabelE1, toggLabelE2, 'underlined', 'off', 'all-');
				showToggle(toggLabelA1, toggLabelA2);
			...
			case 'seltm': {
				...
				toggleBtn(0, '#btnSeltm-0', toggLabelA1, toggLabelA2, 'underlined', 'on');
				showToggle(toggLabelA1, toggLabelA2);
			...
			case 'crptm': {
				let count = 1, toggleCount1 = 0, toggleCount2 = 0;
				...
				const tgBtn = [toggLabelA1, toggLabelB1];
				let currBtn = '';
				let maxCharGeo = 8;
				let maxCharLat = 15;
					...
					if (listBtnCrptm[id][0] != '') {
						...
						switch (id) {
							...
							case 3:
								...
								showNumBtn('#btnCrptm-', 30, 40, listBtnCrptm, 1);
							...
							case 5:
								...
								if ($('#btnCrptm-' + id).text() == btn1[1].toString()) {
									$('.cursor i').removeClass('d-none');
									tipGeoLat();
									toggleCount1 = 1;
								} else if ($('#btnCrptm-' + id).text() == btn1[2].toString()) {
									$('.cursor i').removeClass('d-none');
									tipGeoLat();
									toggleCount1 = 2;
								} else {
							...
							case 6:
								...
								if ($('#btnCrptm-' + id).text() == btn2[1].toString()) {
									$('.cursor i').removeClass('d-none');
									tipGeoLat();
									toggleCount2 = 1;
								} else if ($('#btnCrptm-' + id).text() == btn2[2].toString()) {
									$('.cursor i').removeClass('d-none');
									tipGeoLat();
									toggleCount2 = 2;
								} else {
							...
							case 7:
								...
								showNumBtn('#btnCrptm-', 30, 40, listBtnCrptm, 3);
								hideAlphaBtn('#btnCrptm-');
								resetToggleBtn(id, listBtnCrptm[id][0]);
								resetThreeState();
								break;
					...
					if (listBtnTrial[id][0] != '') {
						...
						switch (id) {
							case 0:
								...
								setTimeout(function () {
									if ($('#input-btn-out').text().toLowerCase() == 'ftr') {
										...
										showNumBtn('#btnTrial-', 30, 40, listBtnTrial, 1);
									}
								}, 125);
								break;
							case 1:
							...
							case 8:
								...
								showNumBtn('#btnTrial-', 30, 40, listBtnTrial, 4);
								count = id + 1;
								break;
							case 40:
								console.log(id + ' fnTrial called');
			...
			case 'delay': {
					...
					if (listBtnDelay[id][0] != '') {
						...
						switch (id) {
							case 0:
								...
								event.stopImmediatePropagation();
								showNumBtn('#btnDelay-', 30, 40, listBtnTrial, 2);
								break;
							case 40:
								console.log(id + ' fnDelay called');
								//event.stopImmediatePropagation();
				...
				delChar('#btnDelay-48');
				showNumBtn('#btnDelay-', 30, 40, listBtnDelay, 2);
				return;
			}
			case 'recovr': {
				let count = 0;
				...
				let toggLabelA2 = 'base';
				let ftrVal = false, recposVal = false;
							...
							case 2:
								...
								setTimeout(function () {
									if ($('#input-btn-out').text().toLowerCase() == 'recpos') {
										...
										showNumBtn('#btnRecovr-', 30, 40, listBtnRecovr, 3);
									} else {
										callAlphaVK('#btnRecovr-', 1);
										showNumBtn('#btnRecovr-', 30, 40, listBtnRecovr, 1);
									}
								}, 125);
								break;
							case 40:
				...
				toggleBtn(2, '#btnRecovr-2', toggLabelA1, toggLabelA2, '', 'on');
			...
			case 'runway': {
					...
					if (listBtnRunway[id][0] != '') {
						...
						switch (id) {
							case 0:
								...
								event.stopImmediatePropagation();
								showNumBtn('#btnRunway-', 30, 40, listBtnRunway, 1);
							...
							case 2:
								...
								setTimeout(function () {
									if ($('#btnRunway-' + id).attr('value') != 'tg-off') {
										showNumBtn('#btnRunway-', 30, 40, listBtnRunway, 2);
									}
								}, 125);
				...
				toggleBtn(2, '#btnRunway-2', toggLabelA1, toggLabelA2, '', 'on');
				$('.cursor i').removeClass('d-none');
									...
									if (count < 16) {
										...
										switch (count) {
											...
											case 4:
												...
												nextStep(count, '#btnDefftr-', listBtnDefftr);
												hideAlphaBtn('#btnDefftr-');
												showNumBtn('#btnDefftr-', 30, 40, listBtnDefftr, 20);
												break;
											case 6:
												if ($('#input-VK').val() == '') {
													$('#input-VK').val('1')
			...
			case 'oncap': {
				...
				showNumBtn('#btnOncap-', 30, 40, listBtnOncap, 1);
			...
			case 'samtrk': {
				...
				showNumBtn('#btnSamtrk-', 30, 40, listBtnSamtrk, 1);
				return;
			}
			case 'ftrres': {
				let count = 0;
				...
				showNumBtn('#btnFtrres-', 30, 40, listBtnFtrres, 1);
				return;
			}
			case 'movbtm': {
			...
			case 'ainit': {
				...
				showNumBtn('#btnAinit-', 30, 40, listBtnAinit, 1);
				return;
			}
			case 'refsrc': {
				let count = 1;
				...
				showNumBtn('#btnRefsrc-', 30, 40, listBtnRefsrc, 1);
				return;
			}
			case 'init': {
				let count = 0;
				...
				$('.cursor i').removeClass('d-none');
				delChar('#btnInit-48');
				showNumBtn('#btnInit-', 30, 40, listBtnInit, 1);
				return;
			}
			case 'updcde': {
				let count = 1;
				...
				showNumBtn('#btnUpdcde-', 30, 40, listBtnUpdcde, 1);
				return;
			}
			case 'remupd': {
				let count = 1;
			...
			case 'updtrk': {
				...
				showToggle(toggLabelB1, toggLabelB2);
				showNumBtn('#btnUpdtrk-', 30, 40, listBtnUpdtrk, 1);
				callAlphaVK('#btnUpdtrk-');
			...
			case 'swap': {
				...
				showNumBtn('#btnSwap-', 30, 40, listBtnSwap, 1);
				callAlphaVK('#btnSwap-');
				return;
			}
			case 'trksrc': {
			...
			case 'radstr': {
				...
				showNumBtn('#btnRadstr-', 30, 40, listBtnRadstr, 1);
				return;
			}
			case 'trkref': {
				let count = 1;
				...
				showNumBtn('#btnTrkref-', 30, 40, listBtnTrkref, 1);
			...
			case 'merge': {
				...
				showNumBtn('#btnMerge-', 30, 40, listBtnMerge, 1);
				callAlphaVK('#btnSwap-');
				return;
			}
			case 'setnac': {
			...
			case 'corr': {
				...
				showNumBtn('#btnCorr-', 30, 40, listBtnCorr, 1);
				callAlphaVK('#btnSwap-');
				return;
			}
			case 'airmov': {
			...
			case 'sfpcur': {
				...
				showNumBtn('#btnSfpcurr-', 30, 40, listBtnSfpcur, 1);
				return;
			}
			case 'cfpact': {
				let count = 0;
...
function isGeoLat(label, toggLabelA, toggLabelB, inputVal) {
	let char = /[A-Z]/g;
	let num = /[0-9]/g;
	let charLat = /N|S/g;
	let charLong = /E|W/g;
	let getInput = '';
	let charCount = 0, numCount = 0, latCount = 0, longCount = 0;
		...
		switch (label) {
			case 'georef':
				...
				if ((charCount != 0 || numCount != 0)) {
					...
					console.log('>> ' + ((charLength == 4)) + ' : ' + (parseInt(numArr[0] + numArr[1]) <= 59) + '-' + (parseInt(numArr[2] + numArr[3]) <= 59));
					console.log(charCount + ' : ' + numCount);
					console.log('>> ' + cekCharFirst + ' : ' + cekNumLast);
					console.log('>> ' + charArr + ' : ' + numArr)
				} else {
			...
			case 'lating':
				...
				let longDDDLength = 3, latALength = 2, longALength = 2;
				latCount = 0;
				longCount = 0;
				...
				for (let j = 0; j < 2; j++) {
					...
					//long
					let cekLongMM = '', cekLongSS = '', cekLongA = '';
				...
				if ((latCount != 0) || (longCount != 0)) {
					if (getInput.length < 12) {
						...
						if (((parseInt(latDDArr[0] + latDDArr[1])) <= 90) && (parseInt(latMMArr[0] + latMMArr[1]) <= 59) && (parseInt(latSSArr[0] + latSSArr[1]) <= 59) && (latAArr != null)) {
							printMessage("COMMAND OK");
						} else {
							printMessage("INVALID LAT");
						}

						if (((parseInt(longDDDArr[0] + longDDDArr[1] + longDDDArr[2])) <= 180) && (parseInt(longMMArr[0] + longMMArr[1]) <= 59) && (parseInt(longSSArr[0] + longSSArr[1]) <= 59) && (longAArr != null)) {
							printMessage("COMMAND OK");
						} else {
							printMessage("INVALID LONG");
						}

						console.log('>> lat: ' + (parseInt(latDDArr[0] + latDDArr[1]) <= 90) + ':' + (parseInt(latMMArr[0] + latMMArr[1]) <= 59) + ':' + (parseInt(latSSArr[0] + latSSArr[1]) <= 59) + ':' + (latAArr != null));
						console.log('>> long: ' + ((parseInt(longDDDArr[0] + longDDDArr[1] + longDDDArr[2])) <= 180) + ':' + (parseInt(longMMArr[0] + longMMArr[1]) <= 59) + ':' + (parseInt(longSSArr[0] + longSSArr[1]) <= 59) + ':' + (longAArr != null));
